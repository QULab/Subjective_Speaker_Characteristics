...
matrix2 <- read.csv(text=getURL(paste0(path_github,"/preferencematrix_from_directscaling_FemalesRateMales.csv")), header=TRUE, sep=",")
...
## Fit BTL
btl1 <- eba(matrix2) # fit Bradley-Terry-Luce model
btl1
# G2(91) = 34.83, p = 1
...
# cbind(usr2[iir2], uss[iir2], usr2[iir2] - uss[iir2]) # real - simulated



# 95% CI for utility scale values
cis <- 1.96 * sqrt(diag(cov.u(btl1))) 
# cbind(cis[ii]) 
